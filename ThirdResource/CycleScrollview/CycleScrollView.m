...
- (id)initWithFrame:(CGRect)frame cycleDirection:(CycleDirection)direction pictures:(NSArray *)pictureArray titleArray:(NSMutableArray *)titleArray
{
    ...
    if(self)
    {
       ...
       scrollView.pagingEnabled = YES;
        ...
        UIImageView *imageview =[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"opcitybg2.png"]];
        [imageview setFrame:CGRectMake(0, frame.size.height-50, frame.size.width, 50)];
        ...
        UILabel *titleLabel =[[UILabel alloc] initWithFrame:CGRectMake(0, frame.size.height-25, 320, 25)];
